...
// public fun new(locked_until_epoch: u64, ctx: &mut TxContext) {
//     let ls = LockedStake {
//         id: object::new(ctx),
//         staked_sui: vec_map::empty(),
//         sui: balance::zero(),
...
//     transfer::transfer(ls, ctx.sender());
// }

// public fun deposit_sui(ls: &mut LockedStake, sui: Coin<SUI>) {
//     balance::join(&mut ls.sui, sui.into_balance());
// }
...
//     let sui_balance = sui_system::request_withdraw_stake_non_entry(sui_system, stake, ctx);
//     let amount = balance::value(&sui_balance);
//     deposit_sui(ls, coin::from_balance(sui_balance, ctx));
//     amount
// }
